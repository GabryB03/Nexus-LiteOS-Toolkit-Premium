namespace WindowsFormsApplication2.Classes
{
	...
	{
		// Token: 0x060002D3 RID: 723 RVA: 0x000892C4 File Offset: 0x000874C4
		...
		// Token: 0x060002D4 RID: 724 RVA: 0x0008933C File Offset: 0x0008753C
		private void InitializeComponent()
		{
			...
			do
			{
				...
				if (num == 63)
				{
					base.KeyDown += new global::System.Windows.Forms.KeyEventHandler(this.applied_KeyDown);
					num = 64;
				}
				if (num == 61)
				{
				...
				if (num == 51)
				{
					base.ClientSize = new global::System.Drawing.Size(304, 131);
					num = 52;
				}
				if (num == 50)
				{
				...
				if (num == 1)
				{
					componentResourceManager = new global::System.ComponentModel.ComponentResourceManager(typeof(global::WindowsFormsApplication2.Classes.applied));
					num = 2;
				}
				if (num == 0)
				{
