namespace WindowsFormsApplication2.Dialog_Boxes
{
	...
	public partial class debloated : global::System.Windows.Forms.Form
	{
		// Token: 0x06000235 RID: 565 RVA: 0x0007EBD8 File Offset: 0x0007CDD8
		...
		// Token: 0x06000236 RID: 566 RVA: 0x0007EC50 File Offset: 0x0007CE50
		private void InitializeComponent()
		{
			...
			do
			{
				...
				if (num == 62)
				{
					base.KeyDown += new global::System.Windows.Forms.KeyEventHandler(this.debloated_KeyDown);
					num = 63;
				}
				if (num == 61)
				{
				...
				if (num == 45)
				{
					this.label1.Size = new global::System.Drawing.Size(125, 34);
					num = 46;
				}
				if (num == 43)
				{
				...
				if (num == 1)
				{
					componentResourceManager = new global::System.ComponentModel.ComponentResourceManager(typeof(global::WindowsFormsApplication2.Dialog_Boxes.debloated));
					num = 2;
				}
				if (num == 0)
				{
