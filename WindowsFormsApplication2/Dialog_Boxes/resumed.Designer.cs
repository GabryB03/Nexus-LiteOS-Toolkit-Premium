namespace WindowsFormsApplication2.Dialog_Boxes
{
	...
	public partial class resumed : global::System.Windows.Forms.Form
	{
		// Token: 0x0600027C RID: 636 RVA: 0x00084460 File Offset: 0x00082660
		...
		// Token: 0x0600027D RID: 637 RVA: 0x000844D8 File Offset: 0x000826D8
		private void InitializeComponent()
		{
			...
			do
			{
				...
				if (num == 62)
				{
					base.KeyDown += new global::System.Windows.Forms.KeyEventHandler(this.resumed_KeyDown);
					num = 63;
				}
				if (num == 65)
				{
				...
				if (num == 47)
				{
					this.label1.Text = "Resumed Winlogon.exe";
					num = 48;
				}
				if (num == 45)
				{
					this.label1.Size = new global::System.Drawing.Size(211, 30);
					num = 46;
				}
				if (num == 44)
				{
				...
				if (num == 1)
				{
					componentResourceManager = new global::System.ComponentModel.ComponentResourceManager(typeof(global::WindowsFormsApplication2.Dialog_Boxes.resumed));
					num = 2;
				}
				if (num == 0)
				{
