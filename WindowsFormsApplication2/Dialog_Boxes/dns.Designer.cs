namespace WindowsFormsApplication2.Dialog_Boxes
{
	...
	public partial class dns : global::System.Windows.Forms.Form
	{
		// Token: 0x0600023F RID: 575 RVA: 0x0007F794 File Offset: 0x0007D994
		...
		// Token: 0x06000240 RID: 576 RVA: 0x0007F80C File Offset: 0x0007DA0C
		private void InitializeComponent()
		{
			...
			do
			{
				...
				if (num == 19)
				{
					this.label1.Size = new global::System.Drawing.Size(246, 34);
					num = 20;
				}
				if (num == 22)
				{
				...
				if (num == 31)
				{
					this.button1.Location = new global::System.Drawing.Point(239, 85);
					num = 32;
				}
				if (num == 34)
				{
				...
				if (num == 63)
				{
					base.KeyDown += new global::System.Windows.Forms.KeyEventHandler(this.dns_KeyDown);
					num = 64;
				}
				if (num == 66)
				{
				...
				if (num == 51)
				{
					base.ClientSize = new global::System.Drawing.Size(341, 125);
					num = 52;
				}
				if (num == 49)
				{
				...
				if (num == 21)
				{
					this.label1.Text = "DNS Cache is running!";
					num = 22;
				}
				if (num == 20)
				{
				...
				if (num == 17)
				{
					this.label1.Location = new global::System.Drawing.Point(78, 28);
					num = 18;
				}
				if (num == 16)
				{
				...
				if (num == 1)
				{
					componentResourceManager = new global::System.ComponentModel.ComponentResourceManager(typeof(global::WindowsFormsApplication2.Dialog_Boxes.dns));
					num = 2;
				}
				if (num == 0)
				{
