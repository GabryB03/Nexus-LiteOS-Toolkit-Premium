namespace WindowsFormsApplication2.Dialog_Boxes
{
	...
	{
		// Token: 0x06000291 RID: 657 RVA: 0x00085C70 File Offset: 0x00083E70
		...
		// Token: 0x06000292 RID: 658 RVA: 0x00085CE8 File Offset: 0x00083EE8
		private void InitializeComponent()
		{
			...
			do
			{
				...
				if (num == 62)
				{
					base.KeyDown += new global::System.Windows.Forms.KeyEventHandler(this.reverted_KeyDown);
					num = 63;
				}
				if (num == 65)
				{
				...
				if (num == 1)
				{
					componentResourceManager = new global::System.ComponentModel.ComponentResourceManager(typeof(global::WindowsFormsApplication2.Dialog_Boxes.reverted));
					num = 2;
				}
				if (num == 0)
				{
