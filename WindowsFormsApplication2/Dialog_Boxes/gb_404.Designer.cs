namespace WindowsFormsApplication2.Dialog_Boxes
{
	...
	public partial class gb_404 : global::System.Windows.Forms.Form
	{
		// Token: 0x06000254 RID: 596 RVA: 0x00081520 File Offset: 0x0007F720
		...
		// Token: 0x06000255 RID: 597 RVA: 0x00081598 File Offset: 0x0007F798
		private void InitializeComponent()
		{
			...
			do
			{
				...
				if (num == 31)
				{
					this.button1.Location = new global::System.Drawing.Point(243, 86);
					num = 32;
				}
				if (num == 34)
				{
				...
				if (num == 63)
				{
					base.KeyDown += new global::System.Windows.Forms.KeyEventHandler(this.gb_404_KeyDown);
					num = 64;
				}
				if (num == 66)
				{
				...
				if (num == 51)
				{
					base.ClientSize = new global::System.Drawing.Size(338, 126);
					num = 52;
				}
				if (num == 49)
				{
				...
				if (num == 1)
				{
					componentResourceManager = new global::System.ComponentModel.ComponentResourceManager(typeof(global::WindowsFormsApplication2.Dialog_Boxes.gb_404));
					num = 2;
				}
				if (num == 0)
				{
