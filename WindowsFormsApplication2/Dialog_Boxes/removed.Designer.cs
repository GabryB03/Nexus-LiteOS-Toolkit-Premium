namespace WindowsFormsApplication2.Dialog_Boxes
{
	...
	{
		// Token: 0x06000272 RID: 626 RVA: 0x0008392C File Offset: 0x00081B2C
		...
		// Token: 0x06000273 RID: 627 RVA: 0x000839A4 File Offset: 0x00081BA4
		private void InitializeComponent()
		{
			...
			do
			{
				...
				if (num == 62)
				{
					base.KeyDown += new global::System.Windows.Forms.KeyEventHandler(this.removed_KeyDown);
					num = 63;
				}
				if (num == 60)
				{
				...
				if (num == 1)
				{
					componentResourceManager = new global::System.ComponentModel.ComponentResourceManager(typeof(global::WindowsFormsApplication2.Dialog_Boxes.removed));
					num = 2;
				}
				if (num == 0)
				{
