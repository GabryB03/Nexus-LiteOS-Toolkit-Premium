namespace WindowsFormsApplication2.Dialog_Boxes
{
	...
	{
		// Token: 0x0600022B RID: 555 RVA: 0x0007E09C File Offset: 0x0007C29C
		...
		// Token: 0x0600022C RID: 556 RVA: 0x0007E114 File Offset: 0x0007C314
		private void InitializeComponent()
		{
			...
			do
			{
				...
				if (num == 62)
				{
					base.KeyDown += new global::System.Windows.Forms.KeyEventHandler(this.cleared_KeyDown);
					num = 63;
				}
				if (num == 64)
				{
				...
				if (num == 1)
				{
					componentResourceManager = new global::System.ComponentModel.ComponentResourceManager(typeof(global::WindowsFormsApplication2.Dialog_Boxes.cleared));
					num = 2;
				}
				if (num == 0)
				{
