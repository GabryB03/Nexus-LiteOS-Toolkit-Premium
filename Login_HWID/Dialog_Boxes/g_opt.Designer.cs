namespace Login_HWID.Dialog_Boxes
{
	...
	public partial class g_opt : global::System.Windows.Forms.Form
	{
		// Token: 0x06000A1D RID: 2589 RVA: 0x0018B864 File Offset: 0x00189A64
		...
		// Token: 0x06000A1E RID: 2590 RVA: 0x0018B8DC File Offset: 0x00189ADC
		private void InitializeComponent()
		{
			...
			do
			{
				...
				if (num == 72)
				{
					base.KeyDown += new global::System.Windows.Forms.KeyEventHandler(this.g_opt_KeyDown);
					num = 73;
				}
				if (num == 71)
				{
				...
				if (num == 60)
				{
					base.ClientSize = new global::System.Drawing.Size(297, 150);
					num = 61;
				}
				if (num == 59)
				{
				...
				if (num == 48)
				{
					this.label1.Size = new global::System.Drawing.Size(68, 34);
					num = 49;
				}
				if (num == 47)
				{
				...
				if (num == 33)
				{
					this.button1.Location = new global::System.Drawing.Point(202, 110);
					num = 34;
				}
				if (num == 32)
				{
				...
				if (num == 23)
				{
					this.label4.Text = "Please select a game before proceeding";
					num = 24;
				}
				if (num == 22)
				{
				...
				if (num == 21)
				{
					this.label4.Size = new global::System.Drawing.Size(225, 19);
					num = 22;
				}
				if (num == 20)
				{
				...
				if (num == 19)
				{
					this.label4.Location = new global::System.Drawing.Point(35, 78);
					num = 20;
				}
				if (num == 18)
				{
				...
				if (num == 1)
				{
					componentResourceManager = new global::System.ComponentModel.ComponentResourceManager(typeof(global::Login_HWID.Dialog_Boxes.g_opt));
					num = 2;
				}
				if (num == 0)
				{
