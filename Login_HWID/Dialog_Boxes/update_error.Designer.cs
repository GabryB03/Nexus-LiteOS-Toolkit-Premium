namespace Login_HWID.Dialog_Boxes
{
	...
	public partial class update_error : global::System.Windows.Forms.Form
	{
		// Token: 0x06000A64 RID: 2660 RVA: 0x00190FA8 File Offset: 0x0018F1A8
		...
		// Token: 0x06000A65 RID: 2661 RVA: 0x00191020 File Offset: 0x0018F220
		private void InitializeComponent()
		{
			...
			do
			{
				...
				if (num == 71)
				{
					base.KeyDown += new global::System.Windows.Forms.KeyEventHandler(this.update_error_KeyDown);
					num = 72;
				}
				if (num == 70)
				{
					this.Text = "update_error";
					num = 71;
				}
				if (num == 69)
				{
				...
				if (num == 60)
				{
					base.ClientSize = new global::System.Drawing.Size(299, 150);
					num = 61;
				}
				if (num == 59)
				{
				...
				if (num == 33)
				{
					this.button1.Location = new global::System.Drawing.Point(204, 110);
					num = 34;
				}
				if (num == 32)
				{
				...
				if (num == 19)
				{
					this.label4.Location = new global::System.Drawing.Point(67, 78);
					num = 20;
				}
				if (num == 18)
				{
				...
				if (num == 1)
				{
					componentResourceManager = new global::System.ComponentModel.ComponentResourceManager(typeof(global::Login_HWID.Dialog_Boxes.update_error));
					num = 2;
				}
				if (num == 0)
				{
