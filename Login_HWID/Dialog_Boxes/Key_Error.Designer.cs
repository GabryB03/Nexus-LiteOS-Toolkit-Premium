namespace Login_HWID.Dialog_Boxes
{
	...
	public partial class Key_Error : global::System.Windows.Forms.Form
	{
		// Token: 0x06000A27 RID: 2599 RVA: 0x0018C520 File Offset: 0x0018A720
		...
		// Token: 0x06000A28 RID: 2600 RVA: 0x0018C598 File Offset: 0x0018A798
		private void InitializeComponent()
		{
			...
			do
			{
				...
				if (num == 72)
				{
					base.KeyDown += new global::System.Windows.Forms.KeyEventHandler(this.Key_Error_KeyDown);
					num = 73;
				}
				if (num == 71)
				{
				...
				if (num == 23)
				{
					this.label4.Text = "Please enter a valid license key!";
					num = 24;
				}
				if (num == 22)
				{
				...
				if (num == 19)
				{
					this.label4.Location = new global::System.Drawing.Point(63, 78);
					num = 20;
				}
				if (num == 18)
				{
				...
				if (num == 1)
				{
					componentResourceManager = new global::System.ComponentModel.ComponentResourceManager(typeof(global::Login_HWID.Dialog_Boxes.Key_Error));
					num = 2;
				}
				if (num == 0)
				{
