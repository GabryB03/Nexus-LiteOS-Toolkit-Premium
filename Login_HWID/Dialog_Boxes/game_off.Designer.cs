namespace Login_HWID.Dialog_Boxes
{
	...
	public partial class game_off : global::System.Windows.Forms.Form
	{
		// Token: 0x06000A09 RID: 2569 RVA: 0x00189F24 File Offset: 0x00188124
		...
		// Token: 0x06000A0A RID: 2570 RVA: 0x00189F9C File Offset: 0x0018819C
		private void InitializeComponent()
		{
			...
			do
			{
				...
				if (num == 71)
				{
					base.KeyDown += new global::System.Windows.Forms.KeyEventHandler(this.game_off_KeyDown);
					num = 72;
				}
				if (num == 70)
				{
				...
				if (num == 50)
				{
					this.label1.Text = "Game Booster Deactivated";
					num = 51;
				}
				if (num == 48)
				{
					this.label1.Size = new global::System.Drawing.Size(288, 34);
					num = 49;
				}
				if (num == 47)
				{
				...
				if (num == 23)
				{
					this.label4.Text = "Game Booster have been deactivated. Getting your PC\r\nback to normal mode";
					num = 24;
				}
				if (num == 22)
				{
				...
				if (num == 21)
				{
					this.label4.Size = new global::System.Drawing.Size(306, 38);
					num = 22;
				}
				if (num == 20)
				{
				...
				if (num == 1)
				{
					componentResourceManager = new global::System.ComponentModel.ComponentResourceManager(typeof(global::Login_HWID.Dialog_Boxes.game_off));
					num = 2;
				}
				if (num == 0)
				{
