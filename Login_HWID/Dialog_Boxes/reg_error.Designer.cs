namespace Login_HWID.Dialog_Boxes
{
	...
	public partial class reg_error : global::System.Windows.Forms.Form
	{
		// Token: 0x06000A4F RID: 2639 RVA: 0x0018F668 File Offset: 0x0018D868
		...
		// Token: 0x06000A50 RID: 2640 RVA: 0x0018F6E0 File Offset: 0x0018D8E0
		private void InitializeComponent()
		{
			...
			do
			{
				...
				if (num == 71)
				{
					base.KeyDown += new global::System.Windows.Forms.KeyEventHandler(this.reg_error_KeyDown);
					num = 72;
				}
				if (num == 70)
				{
				...
				if (num == 1)
				{
					componentResourceManager = new global::System.ComponentModel.ComponentResourceManager(typeof(global::Login_HWID.Dialog_Boxes.reg_error));
					num = 2;
				}
				if (num == 0)
				{
