namespace Login_HWID.Dialog_Boxes
{
	...
	public partial class LoginUser_Error : global::System.Windows.Forms.Form
	{
		// Token: 0x06000A31 RID: 2609 RVA: 0x0018D1DC File Offset: 0x0018B3DC
		...
		// Token: 0x06000A32 RID: 2610 RVA: 0x0018D254 File Offset: 0x0018B454
		private void InitializeComponent()
		{
			...
			do
			{
				...
				if (num == 72)
				{
					base.KeyDown += new global::System.Windows.Forms.KeyEventHandler(this.LoginUser_Error_KeyDown);
					num = 73;
				}
				if (num == 71)
				{
					this.Text = "LoginUser_Error";
					num = 72;
				}
				if (num == 70)
				{
				...
				if (num == 33)
				{
					this.button1.Location = new global::System.Drawing.Point(174, 110);
					num = 34;
				}
				if (num == 32)
				{
				...
				if (num == 19)
				{
					this.label4.Location = new global::System.Drawing.Point(58, 78);
					num = 20;
				}
				if (num == 18)
				{
				...
				if (num == 1)
				{
					componentResourceManager = new global::System.ComponentModel.ComponentResourceManager(typeof(global::Login_HWID.Dialog_Boxes.LoginUser_Error));
					num = 2;
				}
				if (num == 0)
				{
